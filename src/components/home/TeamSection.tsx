...
const avatarData = [
  { image: "/image1.png", name: "Digital-агентства", bgColor: "#E6E6FA" },
  { image: "/image2.png", name: "Production студии", bgColor: "#FCE4EC" },
  { image: "/image3.png", name: "Дизайн студии", bgColor: "#E6FFE6" },
  { image: "/image4.png", name: "Фрилансеры", bgColor: "#FDF6E3" },
  { image: "/image5.png", name: "Предприниматели", bgColor: "#E6F0FA" },
];
...
const mobileAvatarData = [
  ...
  { image: "/image4.png", name: "Фрилансеры", bgColor: "#FDF6E3" },
  { image: "/image5.png", name: "Предприниматели", bgColor: "#E6F0FA" },
  { image: "/image6.png", name: "Продакт менеджеры", bgColor: "#E8F4FD" },
];

export function HeroSection() {
  return (
    // was <main>; changed to <section> to avoid nested <main>
    <section className="dark:bg-white">
      <section className="w-full xl:max-w-[1600px] mx-auto bg-white z-0">
        <div className="mx-auto px-4 xl:px-7">
          <div className="text-left md:text-center">
            ...
            <div className="lg:max-w-2xl font-lato pb-2 lg:pb-10 w-full mx-auto">
              ...
              {/* Subheading */}
              <div className="text-[16px] md:text-[18px] text-[#666666] leading-[24px] lg:leading-[26px] font-normal md:mx-auto mb-6 md:mb-12 text-left md:text-center flex flex-col gap-[16px] md:gap-0">
                <p className="md:mb-4">
            ...
            <div className="text-center mb-4 lg:hidden">
              <p className="text-[24px] leading-6 font-caveat font-normal text-[#333333]">
                ...
                <span className="relative px-1">
                  работают
                  {/* was <div>; changed to <span> to keep it valid inside <p> */}
                  <span className="absolute -rotate-12 top-5 right-0 inline-block">
            ...
            <div className="flex justify-center items-center mb-4 xs:mb-6 sm:mb-8 relative">
              ...
              <div className="absolute overflow-hidden right-60 -top-10 xl:top-0 -mt-10 z-10 hidden lg:block rotate-12">
                <p className="text-[40px] leading-[82px] font-caveat font-normal text-[#333333] transform origin-bottom-right">
                  с нами{" "}
                  <span className="relative px-1">
                    работают
                    <span className="absolute -rotate-12 -bottom-2 right-0 inline-block">
                      <img
                        src="/underline.svg"
              ...
              <div className="grid grid-cols-2 lg:grid-cols-5 gap-4">
                ...
                <div className="hidden lg:contents">
                  {avatarData.map((avatar, index) => (
                    <div
                      key={`desktop-${index}`}
                      className="flex flex-col justify-between items-center p-1 xs:p-1 xl:p-2 rounded-2xl shadow-lg hover:shadow-xl transition-shadow duration-300 bg-[#F9F9FA]"
                      style={{
                    ...
                    >
                      ...
                      >
                        <Image
                          ...
                          height={200}
                          quality={100}
                          className="object-contain w-36 h-36 xl:w-48 xl:h-48"
                        />
                      </div>
                      <div className="text-center">
                        <p className=" text-[22px] xl:text-[28px] font-caveat font-normal leading-[42px] text-[#000000]">
                          {avatar.name}
                        </p>
                      </div>
                    </div>
            ...
            <div className="text-center pt-1">
              <button className="inline-block bg-[#3990FF] text-white px-6 py-3 md:py-0 md:h-[48px] font-lato rounded-full font-light lg:font-medium text-[15px] xl:text-[17px] leading-[24px] lg:leading-[26px] hover:bg-[#0056b3] transition-colors duration-200 shadow-md hover:shadow-lg">
