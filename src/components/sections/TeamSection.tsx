        ...
        <div className="  mx-auto px-4 md:px-7">
          <div className="text-left md:text-center">
                ...
                <div className="hidden lg:contents">
                  {avatarData.map((avatar, index) => (
                    ...
                    >
                      ...
                      <div className="text-center ">
                        <p className=" lg:text-[28px] font-caveat font-normal leading-[42px] text-[#000000]">
                          {avatar.name}
                        </p>
                      </div>
                    </div>
            ...
            <div className="text-center pt-1">
              <button className="inline-block bg-[#3990FF] text-white px-6 py-3 font-lato rounded-full font-light lg:font-medium text-[15px] lg:text-[17px] leading-[24px] lg:leading-[26px] hover:bg-[#0056b3] transition-colors duration-200 shadow-md hover:shadow-lg">
