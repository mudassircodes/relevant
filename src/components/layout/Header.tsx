...
export function Header() {
  ...
  return (
    <section className="bg-white dark:bg-white lg:h-screen " >
      <header
        id="home"
        className="w-full px-4 md:px-14 bg-[#ddf1ff] overflow-hidden rounded-b-[60px] relative z-10"
      >
          ...
          <div className="navbar w-full transition-all duration-800 ease-out bg-transparent lg:bg-white rounded-[100px] shadow-none lg:shadow-[2px_5px_34px_0px_#7695aa61]">
            <div className="navbar_area_wrapper mx-auto w-full p-3 rounded-[100px] flex justify-between items-center bg-transparent lg:bg-white shadow-none lg:shadow-[2px_5px_34px_0px_#7695aa61]">
              <div className="logo">
                <Link
                  href="#home"
                  className="h-[50px] sm:h-[50px] lg:h-[54px] flex items-center"
                >
                  <Image
              ...
              <div
                ...
                className={`w-full flex justify-between items-center ${
                  isMenuOpen
                    ? "fixed inset-0 z-50 bg-black/80 backdrop-blur-sm lg:static lg:bg-transparent lg:flex"
                    : "hidden lg:flex"
                }`}
              >
                <div
                ...
                <div className="hero_left_area_wrapper flex flex-col gap-6 sm:gap-8 lg:gap-12">
                  ...
                  <div className="hero_meta flex flex-col gap-4 sm:gap-6 lg:gap-8">
                    ...
                    <h1 className="font-raleway text-base sm:text-lg md:text-xl font-normal leading-6 sm:leading-7 text-justify text-black max-w-[360px] sm:max-w-[400px] md:max-w-[440px] lg:max-w-[480px]">
                      Здесь можно нанять специалиста на проект, задачу напрямую
                      — без чатов, спама и ожидания
                    </h1>
                  </div>
                  ...
                  <div className="hero_bottom_meta flex flex-col justify-start items-start gap-4 sm:gap-6 lg:gap-8">
                    ...
                    <div className="hidden lg:flex flex-col md:flex-row gap-5">
                      <button className="text-white bg-blue-600 w-full sm:w-auto px-6 py-3 rounded-full cursor-pointer transition-all duration-200 ease font-raleway text-sm sm:text-base font-semibold leading-6 text-center hover:bg-blue-700 flex items-center justify-center">
                        Разместить задачу
                      </button>
                      <button className="text-blue-600 border border-blue-600 bg-blue-50 w-full sm:w-auto px-6 py-3 rounded-full cursor-pointer transition-all duration-200 ease font-raleway text-sm sm:text-base font-semibold leading-6 text-center hover:bg-blue-100 flex items-center justify-center">
                        Найти исполнителя
                      </button>
                    </div>
                  </div>
